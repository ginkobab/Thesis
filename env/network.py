...
import numpy as np
import os
from env.helpers import adj_w_ext_to_K
from env.helpers import synapses_th_matrix
from env.helpers import get_total_number_of_synapses
from env.helpers import get_weight
from env.helpers import plot_raster
from env.helpers import fire_rate
from env.helpers import boxplot
from env.helpers import compute_DC
...
class Network:
    ...
    def __init__(self, sim_dict, net_dict, stim_dict=None):
        ...
        if nest.Rank() == 0:
            if not os.path.isdir(self.sim_dict['data_path']):
